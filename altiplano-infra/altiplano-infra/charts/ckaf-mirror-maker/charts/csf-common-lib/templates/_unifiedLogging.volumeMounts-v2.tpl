...
----
volumeMounts:
  {{- include "csf-common-lib.v2.unifiedLogging.volumeMounts" (tuple . .Values.core (include "csf-common-lib.v1.coalesceBoolean" (tuple .Values.certManager.enabled .Values.global.certManager.enabled false))) | indent 8 }}
----
...
*/}}
{{- define "csf-common-lib.v2.unifiedLogging.volumeMounts"}}
{{- $root     := (index . 0 ) }}
{{- $workload     := (index . 1 ) }}
