...
{{- include "csf-common-lib.v2.pdb" (tuple . .Values.core) }}
{{- end}}
----
...
metadata:
  name: {{ include "csf-common-lib.v1.resourceName" (tuple $root "PodDisruptionBudget" $workload.nameSuffix) }}
  labels:
