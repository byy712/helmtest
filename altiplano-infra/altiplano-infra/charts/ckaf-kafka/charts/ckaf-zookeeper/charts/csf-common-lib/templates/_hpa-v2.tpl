...
{{- include "csf-common-lib.v2.hpa" (tuple . .Values.core) }}
{{- end}}
----
...
metadata:
  name: {{ include "csf-common-lib.v1.resourceName" (tuple $root "HorizontalPodAutoscaler" $workload.nameSuffix) }}
  labels:
...
spec:
  scaleTargetRef:
    ...
    kind: {{ $workload._kind }}
    name: {{ include "csf-common-lib.v1.workloadName" (tuple $root $workload) }}
