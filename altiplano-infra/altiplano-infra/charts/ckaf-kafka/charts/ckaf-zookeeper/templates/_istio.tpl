{{- define "ckaf-zookeeper.istio.initIstio" -}}
...
{{- define "ckaf-zookeeper.istio.psp" -}}
{{- include "ckaf-zookeeper.istio.initIstio" . }}
{{- if and (eq $.istio.cni.enabled false) (eq $.istio.enabled true) ( eq (include "ckaf-zookeeper.PspCreation" .) "true") }}
