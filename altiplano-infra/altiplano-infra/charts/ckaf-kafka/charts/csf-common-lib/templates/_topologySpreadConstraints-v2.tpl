...
* fix issue with multiple topologySpreadConstraint entries
...
spec:
  template:
    spec:
      ...
      topologySpreadConstraints: {{- include "csf-common-lib.v2.topologySpreadConstraints" (tuple . .Values.echoserver) | nindent 8 }}
      {{- end }}
----
...
****
*/}}
{{- define "csf-common-lib.v2.topologySpreadConstraints" -}}
{{- $root := index . 0 }}
{{- $workload := index . 1 }}
