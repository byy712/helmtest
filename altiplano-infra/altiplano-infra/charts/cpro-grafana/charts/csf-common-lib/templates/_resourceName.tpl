...
----
metadata:
  name: {{ include "csf-common-lib.v1.resourceName" (tuple . "StatefulSet" .Values.core.nameSuffix) }}
----
...
----
metadata:
  name: {{ include "csf-common-lib.v1.resourceName" (tuple . "ConfigMap") }}
----
...
****
*/}}
{{- define "csf-common-lib.v1.resourceName" -}}
{{- $root := index . 0 }}
{{- $kind := index . 1 }}
{{- $suffix := "" }}
{{- if gt (len .) 2 }}
...
{{- if has (lower $kind) (get $nameLimits "podNamePrefixKinds") }}
    {{- $podNamePrefix = (($root.Values.global | default dict).podNamePrefix | default "") | trunc $podNamePrefixMaxLength  | trimSuffix "-" }}
    {{- if $podNamePrefix }}
...
For more info see description of `csf-common-lib.v1.resourceName`
...
----
metadata:
  name: include "csf-common-lib.v1.workloadName" (tuple . .Values.core)
----
*/}}
{{- define "csf-common-lib.v1.workloadName" -}}
{{- $root := index . 0 }}
{{- $workload := index . 1 }}
{{- $kind := $workload._kind }}
{{- $suffix := $workload.nameSuffix | default "" }}
{{- include "csf-common-lib.v1.resourceName" (tuple $root $kind $suffix) }}
{{- end }}
