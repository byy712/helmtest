...
In case your backend provides absolute path url (like /static/, /images/, /css/), you may need to rewrite http response. This can be achieved thanks to sub_filter and [configuration-snippet annotation](ingress.md#snippet-code)

Add many sub_filter as needed
...
metadata:
  annotations:
    ...
    nginx.ingress.kubernetes.io/configuration-snippet: |
      ...
      sub_filter /static/ /server1/static/;
      sub_filter /img/ /server1/img/;
      sub_filter_once off;
      sub_filter_types *;
spec:
  rules:
  - http:
      paths:
      - backend:
          serviceName: nginx-ab-citm-server
          servicePort: 8080
        path: /server1/(.*)
```
...
See also controller.enableHttp2OnHttp in README.md#configuration, for activating it on all ingresses
