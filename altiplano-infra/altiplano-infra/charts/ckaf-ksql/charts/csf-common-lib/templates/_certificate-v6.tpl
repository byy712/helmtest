...
### [v6]
#### Changed
* use new csf-common-lib.v6.certificateValues with fix for `subject` field

### [v5]
#### Changed
* csf-common-lib.v5.certificateValues
* added new optional `behaviorFlavor` parameter (passed to `csf-common-lib.v5.certificateValues`)
* added new optional `forceSecretName` parameter (passed to `csf-common-lib.v5.certificateValues`)
...
*/}}
{{- define "csf-common-lib.v6.certificate" -}}
{{- $root := index . 0 }}
{{- $workload := index . 1 }}
...
kind: Certificate
metadata:
  name: {{ include "csf-common-lib.v3.resourceName" (tuple $root "Certificate" $workload.nameSuffix) }}
  labels:
...
spec:
{{ include "csf-common-lib.v6.certificateValues" (tuple $root $workload $certificate $behaviorFlavor $forceSecretName) | indent 2 }}
{{- end }}
