...
+
----
{{- include "csf-common-lib.v2.unifiedLogging.configMap" (tuple . .Values.core) }}
----
...
*/}}
{{- define "csf-common-lib.v2.unifiedLogging.configMap" -}}
{{- $root     := (index . 0 ) }}
{{- $workload     := (index . 1 ) }}
...
data:
  log4cxxproperty:
{{- (include "csf-common-lib.v1.unifiedLogging.config" (tuple $root $workload $certManagerEnabled)) | quote | indent 4 }}
{{- end }}