...
*/}}
{{- define "csf-common-lib.v5.certificate" -}}
{{- $root := index . 0 }}
{{- $workload := index . 1 }}
...
spec:
{{ include "csf-common-lib.v5.certificateValues" (tuple $root $workload $certificate $behaviorFlavor $forceSecretName) | indent 2 }}
{{- end }}
