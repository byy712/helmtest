...
spec:
  template:
    spec:
      affinity: {{- include "csf-common-lib.v2.podAntiAffinity" (tuple . .Values.core) | nindent 8}}
----
...
spec:
  template:
    spec:
      ...
      {{- include "csf-common-lib.v2.podAntiAffinity" (tuple . .Values.echoserver (.Values.affinity | default dict).podAntiAffinity) | indent 8}}
      {{- end }}
----
...
*/}}
{{- define "csf-common-lib.v2.podAntiAffinity" -}}
{{- $root := index . 0 }}
{{- $workload := index . 1 }}
