...
----
spec:
{{ include "csf-common-lib.v2.certificateValues" (tuple . .Values.echoserver.certificate .Values.echoserver) | indent 2 }}
----
...
*/}}
{{- define "csf-common-lib.v2.certificateValues" -}}
{{- $root := index . 0 }}
{{- $certificate := index . 1 }}
{{- $workload := index . 2 }}
...
*/}}
{{- define "csf-common-lib.v2.certificateSecretName" -}}
{{- $root := index . 0 }}
{{- $certificate := index . 1 }}
{{- include "csf-common-lib.v2.resourceName" (tuple $root "Secret" ($certificate.nameSuffix | default "cert")) }}
{{- end }}